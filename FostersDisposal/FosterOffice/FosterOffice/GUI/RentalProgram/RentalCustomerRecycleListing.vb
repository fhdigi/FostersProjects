...
Public Class RentalCustomerRecycleListing
    ...
    Private Sub RentalCustomerRecycleListing_FillEmptySpace(sender As Object, e As DevExpress.XtraReports.UI.BandEventArgs) Handles Me.FillEmptySpace

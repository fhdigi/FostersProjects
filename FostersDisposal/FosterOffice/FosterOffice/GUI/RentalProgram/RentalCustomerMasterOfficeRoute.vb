...
Public Class RentalCustomerMasterOfficeRoute
    ...
    Private Sub RentalCustomerMasterOfficeRoute_FillEmptySpace(sender As Object, e As DevExpress.XtraReports.UI.BandEventArgs) Handles Me.FillEmptySpace
